...
CREATE TABLE `address` (
  ...
  KEY `member_no_s_idx` (`member_no`),
  CONSTRAINT `member_no_s` FOREIGN KEY (`member_no`) REFERENCES `member` (`member_no`)
...
CREATE TABLE `goods` (
  ...
  CONSTRAINT `address_no` FOREIGN KEY (`address_no`) REFERENCES `address` (`address_no`)
...
INSERT INTO `goods` VALUES (3,'유용한 상품',30000,3),(3,'저렴한 상품',20000,1),(3,'좋은 상품',10000,2),(6,'3가지 허브 시골빵',6000,NULL),(6,'김밝은 농부의 서리태 통밀빵',5000,NULL),(6,'단팥 쑥 시골빵 ',6000,NULL),(6,'두부 브라우니',3000,NULL),(6,'미숫가루 통밀스콘',2500,NULL),(6,'바질 치아바타 ',3000,NULL),(6,'발렌타인 데이 초코스콘',2500,NULL),(6,'병아리콩 가득 통밀빵',5000,NULL),(6,'쑥 치아바타',3500,NULL),(6,'쑥 플레인 깜빠뉴',6000,NULL),(6,'영양가득 호밀빵 ',8000,NULL),(6,'올리브 깜빠뉴',7000,NULL),(6,'올리브 치아바타',3500,NULL),(6,'자가제분 통밀식빵',8000,NULL),(6,'장모님 통밀빵',4500,NULL),(6,'착한 팥앙금 통밀빵',5000,NULL),(6,'초코 바게트',5000,NULL),(6,'치유의 빵',7700,NULL),(6,'호밀 펌퍼니클 ',8000,NULL),(6,'홍순영 농부 금강밀 시골빵',6000,NULL),(6,'홍순영 농부 호밀빵',8000,NULL),(8,'아말피코스트 호텔 숙박',150000,2),(8,'이탈리아 숙박',200000,1),(11,'3가지 허브 시골빵',6000,7),(11,'바질 치아바타',3000,9),(11,'영양가득 호밀빵',8000,4),(11,'올리브 깜빠뉴',7000,8),(11,'자가제분 통밀식빵',8000,2),(11,'치유의 빵',7700,1),(11,'호밀 펌퍼니클',8000,5),(11,'홍순영 농부 금강밀 시골빵',6000,6),(11,'홍순영 농부 호밀빵',8000,3);
...
CREATE TABLE `order_goods` (
  ...
  PRIMARY KEY (`order_no`,`goods_name`),
  KEY `order_no_idx` (`order_no`),
  CONSTRAINT `order_no` FOREIGN KEY (`order_no`) REFERENCES `order_info` (`order_no`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `order_goods` VALUES (12,'저렴한 상품',20000,1,NULL),(12,'좋은 상품',10000,1,'메모'),(13,'단팥 쑥 시골빵 ',6000,1,NULL),(13,'바질 치아바타 ',3000,1,NULL),(14,'두부 브라우니',3000,1,NULL),(15,'김밝은 농부의 서리태 통밀빵',5000,1,NULL),(15,'미숫가루 통밀스콘',2500,1,NULL),(16,'병아리콩 가득 통밀빵',5000,1,NULL),(17,'미숫가루 통밀스콘',2500,1,NULL),(17,'영양가득 호밀빵 ',8000,1,NULL),(19,'3가지 허브 시골빵',6000,1,'얇게 썰어주세요'),(19,'바질 치아바타',3000,2,NULL),(19,'치유의 빵',7700,1,NULL),(21,'영양가득 호밀빵',8000,1,NULL),(21,'자가제분 통밀식빵',8000,1,NULL),(21,'호밀 펌퍼니클',8000,2,'자르지 말아주세요'),(22,'치유의 빵',7700,5,NULL),(24,'3가지 허브 시골빵',6000,2,NULL),(24,'영양가득 호밀빵',8000,1,NULL);
...
-- Dump completed on 2019-04-08 16:00:58
