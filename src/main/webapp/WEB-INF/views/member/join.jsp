  ...
  <div class="join-form">
    <form method="post" action="${contextPath}/member/join.do">
        <table class="join-table">
            ...
            <tr><td><input type="text" name="member_name" id="inputName" class="form-control" placeholder="이름을 입력하세요" autofocus></td></tr>
            <tr><td><label for="inputEmail">이메일</label></td> </tr>
            <tr><td><input type="email" name="email_id" class="form-control" id="inputEmail" placeholder="이메일을 입력하세요"></td></tr>
            <tr><td><label for="inputPassword">비밀번호</label></td></tr>
            <tr><td><input type="password" name="member_pw" class="form-control" id="inputPassword" placeholder="비밀번호를 입력하세요"></td></tr>
            <tr><td><label for="inputPasswordCheck">비밀번호 확인</label></td></tr>
            <tr><td><input type="password" name="member_pwck" class="form-control" id="inputPasswordCheck" placeholder="비밀번호를 입력하세요"></td></tr>
            <tr></tr>
