...
$(document).ready(function() {
	$("#add-row").click(function() {
		$("#product_table > tbody:first").append('<tr><td><button type="button" class="delete-row" onclick="deleteRow()"><i class="fas fa-minus-circle"></i></button>'
...
<div class="content-block">
        ...
        <aside>
          ...
          <table class="table table-bordered" id="product_table">
            ...
            <tbody>
                ...
                <tr>
                  <td><button type="button" class="delete-row"><i class="fas fa-minus-circle"></i></button>
          ...
          <input type="hidden" name="goods_address" value="${address.goods_address }">
          <input type="hidden" name="member_no" value="${address.member_no }">
          <button type="button" class="btn btn-primary" onclick="checkName()">수정하기</button>
          </div>
          </form>
        </aside>
      </div>
  ...
  function checkShipping() {
	...
	function deleteRow() {
		$("#product_table > tbody:last > tr:last").remove();
  	});
  </script>
</html>